...
class Sketch:
    ...
    def controller(self):
        ...
        self.segment_1 = Label(self.controller_set,text="Shapes and lines",bg="#FF6347",fg="green",font=("Arial", 12, "bold"),relief=GROOVE,bd=1,padx=10,pady=1)
        self.segment_1.place(x=40,y=3)

        self.line_img = ImageTk.PhotoImage(Image.open("sketch_images/line.jpg").resize((20, 20), Image.ANTIALIAS))
        ...
        self.das_img = ImageTk.PhotoImage(Image.open("sketch_images/dashed_line.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.rectangle_img = ImageTk.PhotoImage(Image.open("sketch_images/rectangle.jpg").resize((20, 20), Image.ANTIALIAS))
        ...
        self.parallelogram_img = ImageTk.PhotoImage(Image.open("sketch_images/parallelogram.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.traingle_img = ImageTk.PhotoImage(Image.open("sketch_images/traingle.jpg").resize((20, 20), Image.ANTIALIAS))
        ...
        self.pentagon_img = ImageTk.PhotoImage(Image.open("sketch_images/pentagon.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.hexagon_img = ImageTk.PhotoImage(Image.open("sketch_images/hexagon.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.arrow_img = ImageTk.PhotoImage(Image.open("sketch_images/arrow.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.circle_img = ImageTk.PhotoImage(Image.open("sketch_images/circle.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.right_angled_traingle_img = ImageTk.PhotoImage(Image.open("sketch_images/right_angled_traingle.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.rounded_rec_img = ImageTk.PhotoImage(Image.open("sketch_images/rounded_rectangle.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.arrow_left_img = ImageTk.PhotoImage(Image.open("sketch_images/left_arrow.png").resize((20, 20), Image.ANTIALIAS))
        ...
        self.segment_2 = Label(self.controller_set, text="Tools Collection", bg="#FF6347", fg="green",
                               font=("Arial", 12, "bold"), relief=GROOVE, bd=1, padx=10, pady=1)
        self.segment_2.place(x=40, y=210)

        self.pencil_img = ImageTk.PhotoImage(Image.open("sketch_images/pencil.png").resize((17, 17), Image.ANTIALIAS))
        ...
        self.eraser_img = ImageTk.PhotoImage(Image.open("sketch_images/eraser.png").resize((17, 17), Image.ANTIALIAS))
        ...
        self.text_img = ImageTk.PhotoImage(Image.open("sketch_images/text_pic.png").resize((17, 17), Image.ANTIALIAS))
        ...
        self.selection_img = ImageTk.PhotoImage(Image.open("sketch_images/selection_box.png").resize((17, 17), Image.ANTIALIAS))
        ...
        self.color_box_img = ImageTk.PhotoImage(Image.open("sketch_images/color_conatiner.png").resize((17, 17), Image.ANTIALIAS))
    ...
    def make_menu(self):
        ...
        for i in range(17):
            ...
            self.menu_img_container[i] = ImageTk.PhotoImage(
                Image.open("sketch_images/" + menu_img[i]).resize((30, 30), Image.ANTIALIAS))
    ...
    def color_set(self):#Color set from colorbox
        ...
        for i in range(15):
            ...
            self.color_container[i] = ImageTk.PhotoImage(Image.open("sketch_images/" + color_storage[i]).resize((15, 15), Image.ANTIALIAS))
        ...
        self.F = Button(self.color_frame, text="F", relief=RAISED, bd=2, bg="black", width=4, height=1,
                            command=lambda: self.activate_coloring(1))
        self.F.grid(row=0, column=5,padx=6)

        self.O = Button(self.color_frame, text="O", relief=RAISED, bd=2, bg="black",width=4, height=1,
                        command=lambda: self.activate_coloring(2))
        self.O.grid(row=1, column=5, padx=6)

        self.permanent_color = Button(self.color_frame, text="P", relief=RAISED, bd=2, bg="black", width=4, height=1,
    ...
    def set_permanent_choose_color(self):#Set permanent color: border and background
        ...
        self.choosing_color = ImageTk.PhotoImage(Image.open("sketch_images/choose_color.png").resize((15, 15), Image.ANTIALIAS))
    ...
    def about(self):#About under Help menu
        ...
        self.about_img[0] = ImageTk.PhotoImage(Image.open("sketch_images/Shapes_and_lines_box.png").resize((200,160),Image.ANTIALIAS))
        self.about_img[1] = ImageTk.PhotoImage(Image.open("sketch_images/Tools_collection.png").resize((200, 100), Image.ANTIALIAS))
        self.about_img[2] = ImageTk.PhotoImage(Image.open("sketch_images/width_controller.png").resize((140, 160), Image.ANTIALIAS))
        self.about_img[3] = ImageTk.PhotoImage(Image.open("sketch_images/Notation_box.png").resize((30, 150), Image.ANTIALIAS))
        self.about_img[4] = ImageTk.PhotoImage(Image.open("sketch_images/Color_segment.png").resize((200, 140), Image.ANTIALIAS))
    ...
    def tips(self):#Tips under Help menu
        ...
        self.about_img[0] = ImageTk.PhotoImage(Image.open("sketch_images/line.jpg").resize((20, 20), Image.ANTIALIAS))
